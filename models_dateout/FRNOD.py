...
from models_dateout.SupportBranch import SupportBranch
from models_dateout.QueryBranch import QueryBranch
from models_dateout.backbone import ResNet, Conv_4
from models_dateout.feature_reconstruction_net.feature_reconstruction_head import FeatureReconstructionHead
from models_dateout.region_proposal_network.rpn import RegionProposalNetwork
from models_dateout.roi_align import FeatureAlign
from models_dateout.BoxRegression_dateout import BoxRegression
from models_dateout.roi_head import FRHead


class FRNOD(nn.Module):

    def __init__(self, way: int, shot: int, query_shot: int, backbone: nn.Module, support_branch: SupportBranch,
                 query_branch: QueryBranch, roi_head: FRHead, box_regression: BoxRegression, post_nms_top_n,
                 is_cuda):
        r"""
        初始化FRNOD网络
        :param way: way
        ...
        self.resolution = self.roi_head.output_size[0] * self.roi_head.output_size[1]
    ...
    def forward_train_trituple(self, s_c, s_n=None, q_c=None, targets=None, scale=1.):
        ...
        result, losses = \
            self.roi_head.forward(support=s,
