...
if __name__ == '__main__':
    ...
    box_predictor = FRPredictor(in_channels=representation_size, num_classes=num_classes, support=support,
                                catIds=[1, 2], Woodubry=True, resolution=resolution, channels=channels, scale=scale)
