...
if __name__ == '__main__':
    ...
    # ----------------------------------------------------------------------------------------
    weight_path = 'weights_fsod_conv4/frnod4_20.pth'
    ...
    with open('datasets/fsod/annotations/fsod_prediction_c4.json', 'w') as f:
        json.dump(eval_results, f)
    # 验证
    gt_path = "datasets/fsod/annotations/fsod_train.json"  # 存放真实标签的路径
    dt_path = "datasets/fsod/annotations/fsod_prediction_c4.json"  # 存放检测结果的路径
    cocoGt = COCO(gt_path)
